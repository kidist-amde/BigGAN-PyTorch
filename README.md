...
## Modifications for conditional face image generation
...
I got a 1.986  inception score for the model trained with the first setup and a 2.111 inception score for the second model. 

The models are trained for the same number of iterations(with the same batch size). The scores seem  close, which suggests that the BigGAN model learns to generate realistic images even when we have smaller sets. In addition, the images generated from the two models also look similar.

### Conditional image generation
Images generated by conditioning the GAN.
 The first image: Conditioned with Black ethnicity . The second image: Conditioned by Asian ethnicity . The third image: Conditioned by White ethnicity . The fourth: Conditioned by Indian ethnicity .


<p>
<img src="img/black.jpg" width = "200"/>
<img src="img/Asian.jpg" width = "200"/>
<img src="img/white.jpg" width = "200"/>
<img src="img/Indian.jpg" width = "200"/>
</p>
...
```bash
mkdir -p models
gdown --id 115x5pxdlC7z6EXg6jTE-WCc2gvIMGB-c 
mv cGAN_best_model.pt models/
```
